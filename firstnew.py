...
Original file is located at
    https://colab.research.google.com/drive/1KZ3ejOZRoPL9U3KmCj4xKb8MLBV5MZX_
"""
...
data = pd.read_csv('AirQualityExcel.csv')
print(data.head())
...
# Iterate over each air pollutant and add a trace to the figure
